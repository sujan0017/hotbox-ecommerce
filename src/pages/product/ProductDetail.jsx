  ...
  return (
    <>
      <div className="grid lg:grid-cols-2 px-10 ">
        ...
        <div className=" lg:pl-5 flex flex-col gap-5  ">
          <div>
          ...
          <div className="flex flex-col gap-1 ">
            ...
            <p className="text-sm text-slate-500">
              ...
              aliquid dolore rem eligendi vel, nemo aliquam non nulla eius eaque
              magnam esse unde animi reprehenderit possimus molestias?
              Laudantium similique delectus eaque ipsam iusto sit odit voluptas
              consequuntur perferendis. Labore nisi earum nobis eveniet eius,
              perspiciatis eos sequi dignissimos assumenda eaque laudantium
              vitae maiores unde quasi praesentium ad id laboriosam soluta?
              Natus provident, architecto fugit, illo in aliquam excepturi
              dignissimos suscipit nam nesciunt libero et. Illum quia hic
              magnam?
            </p>
          </div>
